...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <?php
	  	global $config;
		$lat = $config->get('monster_options_google_lat');
		$lng = $config->get('monster_options_google_lng');
		$mapIcon = $config->get('monster_options_map_icon');
	  ...
	  ?>
		<script>
            function initialize() {
                  ...
                  var image = '<?php echo HTTP_SERVER . 'image/' . $mapIcon; ?>';
